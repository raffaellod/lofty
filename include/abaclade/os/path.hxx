...
#ifndef _ABACLADE_OS_PATH_HXX
#define _ABACLADE_OS_PATH_HXX
...
template <>
class ABACLADE_SYM to_text_ostream<os::path> {
public:
   ...
   */
   void write(os::path const & op, io::text::ostream * ptos);
};
...
#endif //ifndef _ABACLADE_OS_PATH_HXX

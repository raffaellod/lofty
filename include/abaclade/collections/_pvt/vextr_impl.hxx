...
all non-template-driven manipulations in non-template code in the “lower-level” hierarchy, which
...
See for abc::text::str and abc::collections::vector for examples of the memory layout of the above
classes. */

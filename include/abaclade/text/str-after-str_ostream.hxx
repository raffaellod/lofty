...
inline str str::format(
   ...
   io::text::str_ostream sos;
   sos.print(*this, t0, t1, t2, t3, t4, t5);
   return sos.release_content();
}
template <
...
inline str str::format(
   ...
   io::text::str_ostream sos;
   sos.print(*this, t0, t1, t2, t3, t4, t5, t6);
   return sos.release_content();
}
template <
   typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6,
...
inline str str::format(
   ...
   io::text::str_ostream sos;
   sos.print(*this, t0, t1, t2, t3, t4, t5, t6, t7);
   return sos.release_content();
}
template <
   typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6,
...
inline str str::format(
   ...
   io::text::str_ostream sos;
   sos.print(*this, t0, t1, t2, t3, t4, t5, t6, t7, t8);
   return sos.release_content();
}
template <
   typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6,
...
inline str str::format(
   ...
   io::text::str_ostream sos;
   sos.print(*this, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9);
   return sos.release_content();
}

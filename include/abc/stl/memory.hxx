...
#ifndef _ABC_STL_MEMORY_HXX
#define _ABC_STL_MEMORY_HXX
...
template <typename T>
template <typename T2>
shared_ptr<T>::shared_ptr(weak_ptr<T2> const & wpt2) :
...
#endif //ifndef _ABC_STL_MEMORY_HXX

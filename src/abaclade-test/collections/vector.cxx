...
public:
   //! See testing::test_case::title().
   virtual istr title() override {
      return ABC_SL("abc::collections::*vector classes – relational operators");
   }
...
public:
   //! See testing::test_case::title().
   virtual istr title() override {
      return ABC_SL("abc::collections::*vector classes – operations with iterators");
   }
...
public:
   //! See testing::test_case::title().
   virtual istr title() override {
      return ABC_SL("abc::collections::*vector classes – removal of trivial elements");
   }
...
public:
   //! See testing::test_case::title().
   virtual istr title() override {
      return ABC_SL("abc::collections::*vector classes – memory management");
   }
...
public:
   //! See testing::test_case::title().
   virtual istr title() override {
      return ABC_SL("abc::collections::*vector classes – item and item array movement");
   }

...
_string_to_string_backend_base::_string_to_string_backend_base(char_range const & crFormat) {
...
void _string_to_string_backend_base::write(
...
size_t _raw_string::hash(size_t cbItem) const {
